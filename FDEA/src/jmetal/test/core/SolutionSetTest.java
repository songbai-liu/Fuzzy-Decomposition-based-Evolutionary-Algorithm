...
/**
 * Created with IntelliJ IDEA. User: Antonio J. Nebro Date: 10/06/13 Time: 07:41
 */
public class SolutionSetTest {
	...
	/**
	 * Test: Check that adding a new solution to an empty solution set leads
	 * this one to have 1 element
	 * 
	 * @throws Exception
	 */
	@Test
	...
	/**
	 * Test: Adding an element to a full solution set must return a false value
