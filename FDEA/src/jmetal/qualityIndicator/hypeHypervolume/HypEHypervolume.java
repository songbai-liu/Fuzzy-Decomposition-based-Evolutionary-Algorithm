...
public class HypEHypervolume {
	...
	public double computeHypervolume(SolutionSet solutionSet,
		...
		int objs = referencePoint.numberOfObjectives();
	...
	public double estimateHypervolume(SolutionSet solutionSet,
			Solution referencePoint, int nrOfSamples) {
		HypEFitness hy = new HypEFitness();
	...
	public void getHVContributions(SolutionSet solutionSet) {
		...
		int objs = solutionSet.get(0).numberOfObjectives();
	...
	void updateReferencePoint(SolutionSet solutionSet) {
		int numberOfObjectives_ = solutionSet.get(0).numberOfObjectives();
