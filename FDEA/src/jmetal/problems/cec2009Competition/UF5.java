...
public class UF5 extends Problem {
	...
	/**
	 * Constructor. Creates a default instance of problem CEC2009_UF5 (30
	 * decision variables)
	 * 
	 * @param solutionType
	 ...
	 *            The solution type must "Real" or "BinaryReal".
	 */
	public UF5(String solutionType, Integer numberOfVariables, int N,
			double epsilon) {
	...
	public void evaluate(Solution solution) throws JMException {
		...
		hj = (0.5 / N_ + epsilon_)
				* Math.abs(Math.sin(2.0 * N_ * Math.PI * x[0]));
