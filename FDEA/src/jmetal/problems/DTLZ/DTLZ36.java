 ...
 */
public class DTLZ36 extends Problem {
	 ...
	 */
	public DTLZ36(String solutionType) throws ClassNotFoundException {
	 ...
	 *            The solution type must "Real" or "BinaryReal".
	 */
	public DTLZ36(String solutionType, Integer numberOfVariables,
	...
	public void evaluate(Solution solution) throws JMException {
		...
		for (int i = 0; i < numberOfObjectives_; i++)
			solution.setObjective(i, Math.pow(f[i], 4));
	} // evaluate
}
