 ...
 */
public class ConvexDTLZ4 extends Problem{
  ...
  */
  public ConvexDTLZ4(String solutionType) throws ClassNotFoundException {
...
//  this(solutionType, 19, 10);//10 objectives 
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal". 
  */
  public ConvexDTLZ4(String  solutionType,
               Integer numberOfVariables,
               Integer numberOfObjectives) {
    numberOfVariables_  = numberOfVariables;
    numberOfObjectives_ = numberOfObjectives;
    numberOfConstraints_= 0;
    problemName_        = "ConvexDTLZ4";
