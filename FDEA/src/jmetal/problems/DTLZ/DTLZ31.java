 ...
 */
public class DTLZ31 extends Problem {
	 ...
	 */
	public DTLZ31(String solutionType) throws ClassNotFoundException {
	 ...
	 *            The solution type must "Real" or "BinaryReal".
	 */
	public DTLZ31(String solutionType, Integer numberOfVariables,
	...
	public void evaluate(Solution solution) throws JMException {
		...
		for (int i = 0; i < numberOfObjectives_; i++)
			solution.setObjective(i, Math.pow(f[i], 0.1));
	} // evaluate
}
