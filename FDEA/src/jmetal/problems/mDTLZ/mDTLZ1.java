 ...
 */
public class mDTLZ1 extends Problem {
	/**
	 ...
	 */
	public mDTLZ1(String solutionType) throws ClassNotFoundException {
	 ...
	 *            The solution type must "Real" or "BinaryReal".
	 */
	public mDTLZ1(String solutionType, Integer numberOfVariables,
	...
	public void evaluate(Solution solution) throws JMException {
		...
		for (int i = 0; i < numberOfObjectives_; i++){
			f[i] = 0.5*h_Position[i]*(1.0+g_Distance[i]);
