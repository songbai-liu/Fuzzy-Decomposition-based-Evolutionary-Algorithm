...
public class ThetaDEA extends Algorithm {
	...
	public ThetaDEA(Problem problem,int fun) {
		super(problem);
		this.fun = fun;
	} // ThetaDEA 
	...
	public SolutionSet execute() throws JMException, ClassNotFoundException {
		...
		//printGD("ThetaDEA_"+problem_.getNumberOfObjectives()+"Obj_"+problem_.getName()+"_HV.txt",HVarray);
