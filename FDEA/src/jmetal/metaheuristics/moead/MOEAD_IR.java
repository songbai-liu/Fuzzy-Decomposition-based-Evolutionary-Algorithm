 ...
 * 		IEEE Transactions on Cybernetics, accepted for publication, Oct. 2014.
 * 
 * Homepage:
 * 		http://www.cs.cityu.edu.hk/~51888309/
 * 		http://www.cs.cityu.edu.hk/~qzhang/cityumop.html
 * 
...
public class MOEAD_IR extends Algorithm {
	...
	public SolutionSet execute() throws JMException, ClassNotFoundException {
		...
		evaluations_    = 0;
		maxEvaluations  = ((Integer) this.getInputParameter("maxGenerations")).intValue();
		
		populationSize_ = ((Integer) this.getInputParameter("populationSize")).intValue();
		maxEvaluations = maxEvaluations * populationSize_;
