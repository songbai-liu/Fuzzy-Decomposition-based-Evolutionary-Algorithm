...
public class FDEA_main_8obj{
	...
	public static void main(String args[]) throws JMException, ClassNotFoundException, SecurityException, IOException{
		...
		if (args.length == 1) {
			...
			if(fun==13){
		  	      problem = new WFG1("Real",14,20,8);
		  	      
		  	      indicators = new QualityIndicator(problem) ;
		  	    	}//problem = new WFG1("Real");
		  	if(fun==14){
		  	      problem = new WFG2("Real",14,20,8);
		  	      
		  	      indicators = new QualityIndicator(problem) ;
		  	    	}//problem = new WFG1("Real");
		  	if(fun==15){
		  	      problem = new WFG3("Real",14,20,8);
		  	      
		  	      indicators = new QualityIndicator(problem) ;
		  	    	}
			if(fun==16){
			      problem = new WFG4("Real",14,20,8);
			...
			if(fun==17){
		  	...
		  	if(fun==18){
		  	      problem = new WFG6("Real",14,20,8);
		  	      
		  	      indicators = new QualityIndicator(problem) ;
		  	    	}//problem = new WFG1("Real");
		  	if(fun==19){
			      problem = new WFG7("Real",14,20,8);
			      
			      indicators = new QualityIndicator(problem) ;
			    	}//problem = new WFG1("Real");
			if(fun==20){
			      problem = new WFG8("Real",14,20,8);
			      
			      indicators = new QualityIndicator(problem);
			    	}
			if(fun==21){
			      problem = new WFG9("Real",14,20,8);
			      
			      indicators = new QualityIndicator(problem) ;
			    	}//problem = new WFG1("Real");
		  	if(fun==22){
			      problem = new MaF1("Real",17,8);
			      
			      indicators = new QualityIndicator(problem) ;
			    	}//problem = new WFG1("Real");
			if(fun==23){
			      problem = new MaF2("Real",17,8);
			      
			      indicators = new QualityIndicator(problem) ;
			    	}
			if(fun==24){
			      problem = new MaF3("Real",17,8);
			      
			      indicators = new QualityIndicator(problem) ;
			    	}//problem = new WFG1("Real");
			if(fun==25){
			      problem = new MaF4("Real",17,8);
			      
			      indicators = new QualityIndicator(problem) ;
			    	}
			if(fun==26){
			      problem = new MaF5_Concave("Real",17,8);
			      
			      indicators = new QualityIndicator(problem) ;
			    	}
			if(fun==27){
			      problem = new MaF6("Real",17,8);
			      
			      indicators = new QualityIndicator(problem) ;
			    	}
			if(fun==28){
			      problem = new MaF7("Real",27,8);
			      
			      indicators = new QualityIndicator(problem) ;
			    	}
			if(fun==29){
			      problem = new MaF8("Real",2,8);
			      
			      indicators = new QualityIndicator(problem) ;
			    	}
			if(fun==30){
			      problem = new MaF9("Real",2,8);
			      
			      indicators = new QualityIndicator(problem) ;
			    	}
			if(fun==31){
			      problem = new MaF13("Real",5,8);
			      
			      indicators = new QualityIndicator(problem) ;
			    	}
	          if(fun==32){
		  	      problem = new WFG41("Real",14,20,8);
		  	      
		  	      indicators = new QualityIndicator(problem) ;
		  	    	}//problem = new WFG1("Real");
		  	if(fun==33){
		  	      problem = new WFG42("Real",14,20,8);
		  	      
		  	      indicators = new QualityIndicator(problem) ;
		  	    	}//problem = new WFG1("Real");
		  	if(fun==34){
		  	      problem = new WFG43("Real",14,20,8);
		  	      
		  	      indicators = new QualityIndicator(problem) ;
		  	    	}
			if(fun==35){
			      problem = new WFG44("Real",14,20,8);
			      
			      indicators = new QualityIndicator(problem) ;
			    	}//problem = new WFG1("Real");
			if(fun==36){
			      problem = new WFG45("Real",14,20,8);
			      
			      indicators = new QualityIndicator(problem) ;
			    	}
		  	if(fun==37){
		  	      problem = new WFG46("Real",14,20,8);
		  	      
		  	      indicators = new QualityIndicator(problem) ;
		  	    	}//problem = new WFG1("Real");
		  	if(fun==38){
			      problem = new WFG47("Real",14,20,8);
			      
			      indicators = new QualityIndicator(problem) ;
			    	}//problem = new WFG1("Real");
			if(fun==39){
			      problem = new WFG48("Real",14,20,8);
		...
		//algorithm = new IHaEA_Min(problem);
		...
		algorithm.setInputParameter("populationSize", 240);
		...
		/*if(fun>=29 && fun<=30){
			population.printVariablesToFile("NHaEA_Min_"+problem.getNumberOfObjectives()+"Obj_"+problem.getName()+"run_"+ (i+1)  + ".txt");
		}*/
		...
		//printGD("DAEA_Min3_"+problem.getNumberOfObjectives()+"Obj_"+problem.getName()+"_HV.txt",HVarray);
		//double sumIGD=0;
		double sumHV=0.0;
		for(int i=0;i<runtimes;i++){
			  //sumIGD+=IGDarray[i];
