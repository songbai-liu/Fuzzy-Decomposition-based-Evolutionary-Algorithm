...
package jmetal.metaheuristics.main;

import jmetal.core.Algorithm;
import jmetal.core.Operator;
import jmetal.core.Problem;
import jmetal.core.SolutionSet;
import jmetal.metaheuristics.maoeac.MaOEA_C;
...
public class MOEA_2obj_main {
	...
	public static void main(String[] args) throws JMException,
		...
		for(int fun=29;fun<=37;fun++){
			...
			if(fun==13){
		  	      problem = new WFG1("Real",8,100,2);
		  	      
		  	      //indicators = new QualityIndicator(problem,"E:\\SRA\\SRA_2016\\truePF\\500000PF\\WFG2.500000p.5D.pf.txt" ) ;
		  	      indicators = new QualityIndicator(problem,"D:\\Matlab\\TruePF\\WFG\\WFG1_2D_5000.txt");
		  	    	}//problem = new WFG1("Real");
		  	if(fun==14){
		  	      problem = new WFG2("Real",8,100,2);
		  	      
		  	      //indicators = new QualityIndicator(problem,"E:\\SRA\\SRA_2016\\truePF\\500000PF\\WFG2.500000p.5D.pf.txt" ) ;
		  	      indicators = new QualityIndicator(problem,"D:\\Matlab\\TruePF\\WFG\\WFG2_2D_5000.txt");
		  	    	}//problem = new WFG1("Real");
		  	if(fun==15){
		  	      problem = new WFG3("Real",8,100,2);
		  	      
		  	      //indicators = new QualityIndicator(problem,"E:\\SRA\\SRA_2016\\truePF\\500000PF\\WFG3.500000p.5D.pf.txt" ) ;
		  	      indicators = new QualityIndicator(problem,"D:\\Matlab\\TruePF\\WFG\\WFG3_2D_5000.txt");
		  	    	}
			if(fun==16){
			      problem = new WFG4("Real",8,100,2);
			...
			if(fun==17){
			      problem = new WFG5("Real",8,100,2);
			      
			      //indicators = new QualityIndicator(problem,"E:\\SRA\\SRA_2016\\truePF\\500000PF\\WFG4.500000p.5D.pf.txt" ) ;
			      indicators = new QualityIndicator(problem,"D:\\Matlab\\TruePF\\WFG\\WFG9_2D_5000.txt");
			    	}
		  	if(fun==18){
		  	      problem = new WFG6("Real",8,100,2);
		  	      
		  	      //indicators = new QualityIndicator(problem,"E:\\SRA\\SRA_2016\\truePF\\500000PF\\WFG4.500000p.5D.pf.txt" ) ;
		  	      indicators = new QualityIndicator(problem,"D:\\Matlab\\TruePF\\WFG\\WFG9_2D_5000.txt");
		  	    	}//problem = new WFG1("Real");
		  	if(fun==19){
			      problem = new WFG7("Real",8,100,2);
			      
			      //indicators = new QualityIndicator(problem,"E:\\SRA\\SRA_2016\\truePF\\500000PF\\WFG4.500000p.5D.pf.txt" ) ;
			      indicators = new QualityIndicator(problem,"D:\\Matlab\\TruePF\\WFG\\WFG9_2D_5000.txt");
			    	}//problem = new WFG1("Real");
			if(fun==20){
			      problem = new WFG8("Real",8,100,2);
			      
			      //indicators = new QualityIndicator(problem,"E:\\SRA\\SRA_2016\\truePF\\500000PF\\WFG4.500000p.5D.pf.txt" );
			      indicators = new QualityIndicator(problem,"D:\\Matlab\\TruePF\\WFG\\WFG9_2D_5000.txt");
			    	}
			if(fun==21){
			      problem = new WFG9("Real",8,100,2);
			...
			if(fun==28){
			      ...
			      indicators = new QualityIndicator(problem,"D:\\Matlab\\TruePF\\MaF\\MaF7_2D_5000.txt") ;
			    	}
			if(fun==29){
		...
		if(fun<=5){//ZDT1-ZDT6
			...
			algorithm.setInputParameter("div2", 199);
		}else if(fun<=44){//UF1-UF7
			algorithm.setInputParameter("swarmSize", 200);
			algorithm.setInputParameter("maxIterations", Gmax);
			algorithm.setInputParameter("T", 20);
			algorithm.setInputParameter("div1", 19);
			algorithm.setInputParameter("div2", 39);
		}else if(fun<=47){//UF8-UF10
			algorithm.setInputParameter("swarmSize", 600);
			algorithm.setInputParameter("maxIterations", 500);
			algorithm.setInputParameter("T", 300);
			algorithm.setInputParameter("div1", 23);
			algorithm.setInputParameter("div2", 23);
		...
		parameters.put("K", 1.0);
		parameters.put("DE_Variant_", "current-to-best/1");
