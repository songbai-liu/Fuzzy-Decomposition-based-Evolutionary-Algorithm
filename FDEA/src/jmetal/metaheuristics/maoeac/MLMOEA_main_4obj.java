...
public class MLMOEA_main_4obj {
	...
	public static void main(String args[]) throws JMException, ClassNotFoundException, SecurityException, IOException{
		...
		if (args.length == 1) {
			...
			if(fun==22){
			      problem = new MaF1("Real",13,4);
			      
			      indicators = new QualityIndicator(problem) ;
			    	}//problem = new WFG1("Real");
			if(fun==23){
			      problem = new MaF2("Real",13,4);
			      
			      indicators = new QualityIndicator(problem) ;
			    	}
			if(fun==24){
			      problem = new MaF3("Real",13,4);
			      
			      indicators = new QualityIndicator(problem) ;
			    	}//problem = new WFG1("Real");
			if(fun==25){
			      problem = new MaF4("Real",13,4);
			      
			      indicators = new QualityIndicator(problem) ;
			    	}
			if(fun==26){
			      //problem = new MaF5_Convex("Real",14,5);
			      problem = new MaF5_Concave("Real",13,4);
			      
			      indicators = new QualityIndicator(problem) ;
			    	}
			if(fun==27){
			      problem = new MaF6("Real",13,4);
			      
			      indicators = new QualityIndicator(problem) ;
			    	}
			if(fun==28){
			      problem = new MaF7("Real",23,4);
			      
			      indicators = new QualityIndicator(problem) ;
			    	}
			if(fun==29){
			      problem = new MaF8("Real",2,4);
			      
			      indicators = new QualityIndicator(problem) ;
			    	}
			if(fun==30){
			      problem = new MaF9("Real",2,4);
			      
			      indicators = new QualityIndicator(problem) ;
			    	}
			if(fun==31){
			      problem = new MaF10("Real",6,20,4);//WFG1
			      
			      indicators = new QualityIndicator(problem) ;
			    	}
			if(fun==32){
			      problem = new MaF11("Real",6,20,4);//WFG2
			      
			      indicators = new QualityIndicator(problem) ;
			    	}
			if(fun==33){
			      problem = new MaF12("Real",6,20,4);//WFG9
			      
			      indicators = new QualityIndicator(problem) ;
			    	}
			if(fun==34){
			      problem = new MaF13("Real",5,4);
			      
			      indicators = new QualityIndicator(problem) ;
			    	}
			 if(fun==35){
			      problem = new mDTLZ1("Real",12,4);
			      
			      indicators = new QualityIndicator(problem) ;
			    	}
	          if(fun==36){
			      problem = new mDTLZ2("Real",12,4);
			      
			      indicators = new QualityIndicator(problem) ;
			    	}
	          if(fun==37){
			      problem = new mDTLZ3("Real",12,4);
			      
			      indicators = new QualityIndicator(problem) ;
			    	}
	          if(fun==38){
			      problem = new mDTLZ4("Real",12,4);
		...
		algorithm.setInputParameter("populationSize", 168);
	...
	/*	parameters = new HashMap();
		...
		population.printObjectivesToFile("MaOEAC_"+problem.getNumberOfObjectives()+"Obj_"+problem.getName()+"_run"+ (i+1)  + ".txt");
		if(fun>=29 && fun<=30){
