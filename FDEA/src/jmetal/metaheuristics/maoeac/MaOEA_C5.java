...
public class MaOEA_C5 extends Algorithm{
	...
	public SolutionSet execute() throws JMException, ClassNotFoundException {
		...
		while (generations_ < maxGenerations_) {
		    ...
		    Ranking tranking = new NondominatedRanking(population_);
		    if(generations_%20 == 0){
		    	wfghvCalculator1 wfg = new wfghvCalculator1(tranking.getSubfront(0),fun);
		    	try {
		...
		printGD("MaOEA_HC_"+problem_.getNumberOfObjectives()+"Obj_"+problem_.getName()+"_HV.txt",HVarray);
