 ...
 * ditance values. NOTE: if you use the default constructor, the problem has to
...
public class RankingAndCrowdingSelection extends Selection {
	...
	public RankingAndCrowdingSelection(HashMap<String, Object> parameters) {
		...
		if (problem_ == null) {
			Configuration.logger_
					.severe("RankingAndCrowdingSelection.execute: "
	...
	public Object execute(Object object) throws JMException {
		...
		while ((remain > 0) && (remain >= front.size())) {
			...
			distance_.crowdingDistanceAssignment(front,
