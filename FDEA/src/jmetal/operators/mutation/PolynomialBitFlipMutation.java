...
public class PolynomialBitFlipMutation extends Mutation {
	...
	public PolynomialBitFlipMutation(HashMap<String, Object> parameters) {
		...
		if (parameters.get("binaryMutationProbability") != null)
			binaryMutationProbability_ = (Double) parameters
					.get("binaryMutationProbability");
	...
	public Object execute(Object object) throws JMException {
		...
		doMutation(realMutationProbability_, binaryMutationProbability_,
				solution);
		return solution;
	} // execute
	 ...
	 * @throws JMException
	 */
	public void doMutation(Double realProbability, Double binaryProbability,
